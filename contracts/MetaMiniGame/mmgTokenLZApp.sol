...
contract XYZ is NonblockingLzApp, ERC20 {
    ...
    {
        // If Source == Polygon test, then Destination Chain = BSC
        if (_lzEndpoint == 0xf69186dfBa60DdB133E91E9A4B5673624293d8F8)
            destChainId = 10102;

        // If Source == BSC, then Destination Chain = Polygon test
        // if (_lzEndpoint == 0x6Fcb97553D41516Cb228ac03FdC8B9a0a9df04A1)
        //     destChainId = 10109;
        endpoint = ILayerZeroEndpoint(_lzEndpoint);
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x8954AfA98594b838bda56FE4C12a09D7739D179b // polygon testnet router
        );
    ...
    uint256 _buyRewardsFee = 20;
        ...
        swapTokensAtAmount = (1000000000000000000000 * 10) / 10000;
        ...
        rewardsWallet = address(0x2e7444C0b9A956e1e9667CacC49b6270A01Bee0e);
        developmentWallet = address(0x536b9c012E101aE9D106B59Ee854381e826c077f);
    ...
    function updateBuyFees(uint256 _rewardsFee, uint256 _developmentFee)
        external
        onlyOwner
    {
    ...
    function updateSellFees(uint256 _rewardsFee, uint256 _developmentFee)
        external
        onlyOwner
    {
    ...
    function updateRewardsWalletInfo(address newRewardsWallet)
        external
        onlyOwner
    {
    ...
    function mintTokens (address _account,uint256 _amount) external onlyOwner{
      ...
      function burnTokens (address _account,uint256 _amount) external onlyOwner{
